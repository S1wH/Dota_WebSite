...
class TestTournament(TestCase):
    ...
    def test_shuffle_teams(self):
        ...
        self.assertEqual(
            stage.shuffle_teams(),
            [(teams[0], teams[5]), (teams[1], teams[4]), (teams[2], teams[3])],
        )
    ...
    def test_stage_winners(self):
        ...
        self.assertEqual(
            semi_finals.stage_winners(), [participants[0], participants[1]]
        )

        final = mixer.blend(
            TournamentStage, stage=TournamentStage.FINAL, tournament=tournament
        )
        ...
        mixer.cycle(3).blend(
            MatchPeriod, win_team=team2, duration=timedelta(minutes=45), match=match
        )
