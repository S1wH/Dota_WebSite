...
class Match(models.Model):
    ...
    team1 = models.ForeignKey(
        Team, on_delete=models.CASCADE, related_name="team1_match"
    )
    team2 = models.ForeignKey(
        Team, on_delete=models.CASCADE, related_name="team2_match"
    )
    status = models.CharField(
        max_length=1, choices=statuses, default=INCOMING, editable=False
    )
...
class MatchPeriod(models.Model):
    ...
    win_team = models.ForeignKey(
        Team, on_delete=models.CASCADE, related_name="team_period_win"
    )
    duration = models.DurationField()
    match = models.ForeignKey(
        Match, on_delete=models.CASCADE, related_name="match_period"
    )
...
class PlayerStats(models.Model):
    ...
    match_period = models.ForeignKey(
        MatchPeriod, on_delete=models.CASCADE, related_name="period_stats"
    )
    player = models.ForeignKey(
        Player, on_delete=models.CASCADE, related_name="player_stats"
    )
